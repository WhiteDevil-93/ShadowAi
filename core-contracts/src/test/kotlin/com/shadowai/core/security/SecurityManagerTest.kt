 ...
 * Uses SecurityMessage (renamed from local Message shadow to avoid collision
 * with com.shadowai.core.Message).
 */
class SecurityManagerTest {
    ...
    fun `secureConversation - should process multiple messages`() = runBlocking {
        // Given
        val messages = listOf(
            SecurityMessage("user", "Hello"),
            SecurityMessage("assistant", "Hi there"),
            SecurityMessage("user", "How are you?")
        )
