 ...
 */
class ChatTransformationView : TransformationView {
    override val viewType: ViewType = ViewType.CHAT
    ...
    override val parameterSchema = ViewParameterSchemas.chatSchema
    ...
    override fun Render(
        ...
        Column(modifier = modifier, verticalArrangement = Arrangement.spacedBy(12.dp)) {
            ...
            Button(
                ...
                Text(if (state.isExecuting) "Running..." else "Send")
            }
